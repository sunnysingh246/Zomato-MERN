...
const FoodPartnerLogin = () => {
	...
	return (
		<AuthLayout role="food-partner" mode="login" title="Welcome back" description="Sign in to continue where you left off.">
			<form className="auth-form" onSubmit={handleSubmit}>
				...
				<Link className="forgot-link" to="/food-partner/login">Forgot password?</Link>
